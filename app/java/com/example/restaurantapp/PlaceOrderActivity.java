...
import com.example.restaurantapp.Model.EventBust.SendTotalCashEvent;
import com.example.restaurantapp.Retrofit.IBraintreeAPI;
import com.example.restaurantapp.Retrofit.IMyRestaurantAPI;
import com.example.restaurantapp.Retrofit.RetrofitBraintreeClient;
                                    ...
                                    mCompositeDisposable.add(mCartDataSource.getAllCart(Common.currentUser.getFbid(),
                                            ...
                                            .subscribe(cartItems -> {
                                                ...
                                                mCompositeDisposable.add(mIMyRestaurantAPI.createOrder(Common.API_KEY,
                                                        ...
                                                        edt_date.getText().toString(),
                                                        Common.currentRestaurant.getId(),
                                                        braintreeTransaction.getTransaction().toString(),
                                                        false,
